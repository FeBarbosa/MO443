...
quantization('../img/foto2A.png', 'foto2A', 2)
quantization('../img/foto2A.png', 'foto2A', 4)
quantization('../img/foto2A.png', 'foto2A', 8)
quantization('../img/foto2A.png', 'foto2A', 16)
quantization('../img/foto2A.png', 'foto2A', 32)
quantization('../img/foto2A.png', 'foto2A', 64)
quantization('../img/foto2A.png', 'foto2A', 128)
